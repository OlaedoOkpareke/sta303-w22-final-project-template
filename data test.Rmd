...
socialmedia_data$emoji_modifier = fct_relevel(socialmedia_data$emoji_modifier, "Light Skin","Medium-Light Skin","Medium Skin","Medium-Dark Skin","Dark Skin")
...
```{r}
levels(socialmedia_data$emoji_modifier)
```
